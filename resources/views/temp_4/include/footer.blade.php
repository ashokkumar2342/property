...
<footer>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-sm-6 col-12 sm-margin-30px-bottom">
                            ...
                            <p class="margin-10px-bottom">{!!@$rs_school_detail[0]->footer_description!!}</p>
                        </div>
                        ...
                        <div class="col-lg-2 col-sm-6 col-12 sm-margin-30px-bottom">
                            <div class="padding-50px-left md-padding-20px-left ms-no-padding-left">
                                ...
                                <ul class="list-style3">
                                    <li>
                                      <a href="{{ route('template.about',[4,1]) }}">
                                        About Us
                                      </a>
                                    </li>
                                    <li>
                                      <a href="{{ route('template.gallery',[4,1]) }}">
                                        Gallery
                                      </a>
                                    </li>
                                    <li>
                                      <a href="{{ route('template.teacher',[4,1]) }}">
                                        Teachers
                                      </a>
                                    </li>
                                    <li>
                                      <a href="{{ route('template.events',[4,1]) }}">
                                        Events
                                      </a>
                                    </li>
                                    <li>
                                      <a href="{{ route('template.contact',[4,1]) }}">
                        ...
                        <div class="col-lg-4 col-sm-6 col-12">
                            <div class="padding-50px-left md-padding-20px-left ms-no-padding-left">
                                <h4 class="font-size22 sm-font-size20 xs-font-size18 font-weight-800 margin-25px-bottom sm-margin-20px-bottom">Contact Us</h4>
                                <ul class="contact-info">
                                    ...
                                    <li><i class="fas fa-map-marker-alt"></i> {{@$rs_school_detail[0]->address}}</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6 col-12 ms-margin-30px-bottom">
                            <h4 class="font-size22 sm-font-size20 xs-font-size18 font-weight-800 margin-25px-bottom sm-margin-20px-bottom ms-margin-15px-bottom">Map</h4>
            ...
            <div class="footer-bar">
                <div class="container">
                    <p>&copy; {{date('Y')}} Designed By EAGESKOOL</p>
                </div>
            </div>
        </footer>
        <!-- end footer section -->
