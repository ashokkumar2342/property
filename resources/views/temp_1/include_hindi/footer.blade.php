    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-6 col-lg-3 col-xs-12">
          <a class="mb-6 d-block" href="{{ route('template.index',[1,2]) }}">
          ...
          <p class="mb-6">{!!@$rs_school_detail[0]->footer_description_l!!}</p>
        </div>

        <div class="col-sm-6 col-lg-3 col-xs-12">
          <h4 class="section-title-sm font-weight-bold text-white mb-6">त्वरित लिंक</h4>
          <ul class="list-unstyled">
            <li class="mb-4">
              <a href="{{ route('template.about',[1,2]) }}">
                <i class="fas fa-angle-double-right me-2" aria-hidden="true"></i>हमारे बारे में
              </a>
            </li>
            <li class="mb-4">
              <a href="{{ route('template.gallery',[1,2]) }}">
                <i class="fas fa-angle-double-right me-2" aria-hidden="true"></i>गैलरी
              </a>
            </li>
            <li class="mb-4">
              <a href="{{ route('template.teacher',[1,2]) }}">
                <i class="fas fa-angle-double-right me-2" aria-hidden="true"></i>अध्यापक
              </a>
            </li>
            <li class="mb-4">
              <a href="{{ route('template.events',[1,2]) }}">
                <i class="fas fa-angle-double-right me-2" aria-hidden="true"></i>आयोजन
              </a>
            </li>
            <li class="mb-3">
              <a href="{{ route('template.contact',[1,2]) }}">
        ...
        <div class="col-sm-6 col-lg-3 col-xs-12">
          <h4 class="section-title-sm font-weight-bold text-white mb-6">संपर्क करें</h4>
          <ul class="list-unstyled list-item-border-bottom">
            ...
            <li class="mb-4 pb-4">
              <div class="media">
                ...
                <div class="media-body">
                  <h5 class="line-hight-16 mb-1">
                    <a class="font-base font-size-14" href="#">{{@$rs_school_detail[0]->address_l}}</a>
                  </h5>
                </div>
              </div>
            </li>
        ...
        <div class="col-sm-6 col-lg-3 col-xs-12">
          <h4 class="section-title-sm font-weight-bold text-white mb-6">नक्शा</h4>
    ...
    <div class="container">
      <div class="row py-4 align-items-center">
        <div class="col-sm-7 col-xs-12 order-1 order-md-0">
          <p class="copyright-text"> © <span id="copy-year"></span> EAGESKOOL द्वारा डिज़ाइन किया गया, Last Update :: {{date('d-M-Y h:i', strtotime(@$rs_school_detail[0]->update_date_time))}}</p>
        </div>
