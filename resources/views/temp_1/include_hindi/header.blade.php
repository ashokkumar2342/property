...
<body id="body" class="up-scroll">
  ...
  <header class="header" id="pageTop">
              ...
              <div class="col-lg-8 d-none d-lg-block">
                <ul class="list-inline d-flex justify-content-xl-start align-items-center h-100 mb-0">
                  <li>
                    ...
                    <a class="me-lg-4 me-xl-6 text-white opacity-80">{{$rs_school_detail[0]->email}}</a>
                  </li>
                  <li>
                    <span class="bg-success icon-header me-xl-2">
                      <i class="fas fa-phone-alt" aria-hidden="true"></i>
                    </span>
                    <a class="me-lg-4 me-xl-6 text-white opacity-80">{{$rs_school_detail[0]->mobile}}</a>
                  </li>
                  <li class="text-white">
                    <span class="bg-pink icon-header">
                      <i class="far fa-clock" aria-hidden="true"></i>
                    </span>
                    <span class="opacity-80">खुलने का समय : {{$rs_school_detail[0]->opening_time_l}}</span>
                  </li>
                </ul>
              </div>
              ...
              <div class="col-lg-4">
                <ul class="list-inline d-flex mb-0 justify-content-xl-end justify-content-center align-items-center me-xl-2">
                  ...
                  <li class="me-3 me-md-4 me-lg-3 me-xl-5 dropdown dropdown-sm">
                    <a class="btn btn-link" type="button" href="{{ route('template.index',[1,1]) }}"> View in English </a>
                  </li>
                  ...
                  <li>
                    ...
                    <a class="text-white font-weight-medium opacity-80" href="{{ route('template.contact',[1,2]) }}">प्रवेश</a>
                    {{-- <a class="text-white font-weight-medium opacity-80" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#modal-createAccount">प्रवेश</a> --}}
                  </li>
                </ul>
              </div>
            </div>
    ...
    <nav class="navbar navbar-expand-md navbar-scrollUp navbar-sticky navbar-white">
      {{-- <div class="container"> --}}
        <a class="navbar-brand" href="{{ route('template.index',[1,2]) }}">
          <img class="d-inline-block" src="{{ asset($rs_school_detail[0]->logo)}}" alt="Kidz School">
        </a>
        <a class="navbar-brand d-inline-block" style="color: " href="{{ route('template.index',[1,2]) }}">
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
          <ul class="navbar-nav ms-lg-auto">
            <li class="nav-item dropdown bg-primary">
              <a class="nav-link dropdown-toggle  active " href="{{ route('template.index',[1,2]) }}">
            ...
            <li class="nav-item dropdown bg-danger">
              <a class="nav-link dropdown-toggle " data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <span title="More Menu">के बारे में</span>
              </a>
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown1">
                <li>
                  <a class="dropdown-item " href="{{ route('template.about',[1,2]) }}">हमारे बारे में</a>
                </li>
                
                  <li>
                    <a class="dropdown-item " href="{{ route('template.whos.message',[1,2])}}">कौन कौन है</a>
                  </li>
              </ul>
            </li>

            {{-- <li class="nav-item dropdown bg-danger">
              <a class="nav-link dropdown-toggle  active " href="{{ route('template.about',[1,2]) }}">
                <i class="fas fa-info nav-icon" aria-hidden="true"></i>
                <span></span>
              </a>
            </li> --}}
            <li class="nav-item dropdown bg-info">
              <a class="nav-link dropdown-toggle  active " href="{{ route('template.gallery',[1,2]) }}">
            ...
            <li class="nav-item dropdown bg-pink">
              <a class="nav-link dropdown-toggle  active " href="{{ route('template.teacher',[1,2]) }}">
            ...
            <li class="nav-item dropdown bg-success">
              <a class="nav-link dropdown-toggle  active " href="{{ route('template.events',[1,2]) }}">
            ...
            <li class="nav-item dropdown bg-danger">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown1">
                <li>
                  <a class="dropdown-item " href="{{ route('template.features',[1,2]) }}">विशेषताएँ</a>
                </li>
                <li>
                  <a class="dropdown-item " href="{{ route('template.infrastructure',[1,2]) }}">आधारभूत संरचना</a>
                </li>
                <li>
                  <a class="dropdown-item " href="{{ route('template.calendar',[1,2])}}">पंचांग</a>
                </li>
                <li>
                  <a class="dropdown-item " href="{{ route('template.CBSEMandatoryDisclosure',[1,2])}}">सीबीएसई अनिवार्य प्रकटीकरण</a>
                </li>
                @foreach ($rs_more_page as $rs_more_page_val)
                  <li>
                    <a class="dropdown-item " href="{{ route('template.morepage',[1,2,$rs_more_page_val->id])}}">{{$rs_more_page_val->link_name_l}}</a>
                  </li>
                @endforeach
              </ul>
            </li>
            <li class="nav-item dropdown bg-purple">
              <a class="nav-link dropdown-toggle  active " href="{{ route('template.contact',[1,2]) }}">
