...
<div class="page-title light-background">
    <div class="container d-lg-flex justify-content-between align-items-center">
        <h1 class="mb-2 mb-lg-0">Otp Verify</h1>
        <nav class="breadcrumbs">
            <ol>
                <li><a href="{{ url('/') }}">Home</a></li>
                <li class="current">Otp Verify</li>
            </ol>
        </nav>
    </div>
</div>
            ...
            <div class="col-lg-10">
                ...
                <div class="row bg-white rounded-4 shadow-lg overflow-hidden">
                    ...
                    <div class="col-md-7 p-5">
                        ...
                        <form action="{{ route('admin.verify.otp',$mobile) }}" method="post" button-click="btn_close"  enctype="multipart/form-data">
                         {{ csrf_field() }}
