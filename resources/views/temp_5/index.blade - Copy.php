              ...
              <div class="hero-visual" data-aos="fade-left" data-aos-delay="400">
                <div class="visual-container">
                  <div class="featured-property">
                    <img src="{{ asset('temp_5/assets/img/real-estate/property-exterior-8.webp')}}" alt="Featured Property" class="img-fluid">
                  ...
                  <div class="overlay-images">
                    <div class="overlay-img overlay-1">
                      <img src="{{ asset('temp_5/assets/img/real-estate/property-interior-4.webp')}}" alt="Interior View" class="img-fluid">
                    </div>
                    <div class="overlay-img overlay-2">
                      <img src="{{ asset('temp_5/assets/img/real-estate/property-exterior-2.webp')}}" alt="Exterior View" class="img-fluid">
                    </div>
                  </div>

                  <div class="agent-card">
                    <div class="agent-profile">
                      <img src="{{ asset('temp_5/assets/img/real-estate/agent-7.webp')}}" alt="Agent Profile" class="agent-photo">
          ...
          <div class="col-lg-5" data-aos="zoom-in" data-aos-delay="200">
            <div class="image-gallery">
              <div class="primary-image">
                <img src="{{ asset('temp_5/assets/img/real-estate/property-exterior-1.webp')}}" alt="Modern Property" class="img-fluid">
              ...
              <div class="secondary-image">
                <img src="{{ asset('temp_5/assets/img/real-estate/property-interior-4.webp')}}" alt="Luxury Interior" class="img-fluid">
              </div>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-8">
            ...
            <div class="featured-property-main" data-aos="zoom-in" data-aos-delay="200">
              <div class="property-hero">
                <img src="{{ asset('temp_5/assets/img/real-estate/property-exterior-4.webp')}}" alt="Luxury Estate" class="img-fluid">
            ...
            <div class="properties-sidebar">
              ...
              <div class="sidebar-property-card" data-aos="fade-left" data-aos-delay="300">
                <div class="sidebar-property-image">
                  <img src="{{ asset('temp_5/assets/img/real-estate/property-exterior-1.webp')}}" alt="Modern Condo" class="img-fluid">
              ...
              <div class="sidebar-property-card" data-aos="fade-left" data-aos-delay="400">
                <div class="sidebar-property-image">
                  <img src="{{ asset('temp_5/assets/img/real-estate/property-exterior-9.webp')}}" alt="Family Home" class="img-fluid">
        ...
        <div class="row gy-4 mt-4">
          ...
          <div class="col-xl-6" data-aos="fade-up" data-aos-delay="600">
            <div class="property-card-horizontal">
              <div class="property-image-horizontal">
                <img src="{{ asset('temp_5/assets/img/real-estate/property-interior-5.webp')}}" alt="Penthouse" class="img-fluid">
          ...
          <div class="col-xl-6" data-aos="fade-up" data-aos-delay="700">
            <div class="property-card-horizontal">
              <div class="property-image-horizontal">
                <img src="{{ asset('temp_5/assets/img/real-estate/property-interior-8.webp')}}" alt="Modern Home" class="img-fluid">
        ...
        <div class="row g-4">
          ...
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
            <div class="service-card">
              ...
              <div class="service-visual">
                <img src="{{ asset('temp_5/assets/img/real-estate/property-interior-2.webp')}}" class="img-fluid" alt="Property Search" loading="lazy">
              </div>
            </div>
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="service-card">
              ...
              <div class="service-visual">
                <img src="{{ asset('temp_5/assets/img/real-estate/property-exterior-1.webp')}}" class="img-fluid" alt="Property Valuation" loading="lazy">
              </div>
            </div>
          </div><!-- End Service Item -->
        ...
        <div class="row g-4 mt-4">
          ...
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="400">
            <div class="service-card">
              ...
              <div class="service-visual">
                <img src="{{ asset('temp_5/assets/img/real-estate/property-interior-8.webp')}}" class="img-fluid" alt="Property Rental" loading="lazy">
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="500">
            <div class="service-card">
              ...
              <div class="service-visual">
                <img src="{{ asset('temp_5/assets/img/real-estate/property-exterior-4.webp')}}" class="img-fluid" alt="Investment Advisory" loading="lazy">
              </div>
            </div>
          </div><!-- End Service Item -->
        ...
        <div class="row gy-4 justify-content-center">
            ...
            <div class="featured-agent">
              <div class="agent-wrapper">
                <div class="agent-photo">
                  <img src="{{ asset('temp_5/assets/img/real-estate/agent-3.webp')}}" alt="Featured Agent" class="img-fluid">
          ...
          <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="featured-agent">
              <div class="agent-wrapper">
                <div class="agent-photo">
                  <img src="{{ asset('temp_5/assets/img/real-estate/agent-7.webp')}}" alt="Featured Agent" class="img-fluid">
                  <div class="overlay-info">
                    <div class="contact-actions">
          ...
          <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="300">
            <div class="featured-agent">
              <div class="agent-wrapper">
                <div class="agent-photo">
                  <img src="{{ asset('temp_5/assets/img/real-estate/agent-5.webp')}}" alt="Featured Agent" class="img-fluid">
                  <div class="overlay-info">
                    <div class="contact-actions">
          ...
          <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="400">
            <div class="featured-agent">
              <div class="agent-wrapper">
                <div class="agent-photo">
                  <img src="{{ asset('temp_5/assets/img/real-estate/agent-9.webp')}}" alt="Featured Agent" class="img-fluid">
                  <div class="overlay-info">
                    <div class="contact-actions">
        ...
        <div class="testimonial-grid">
            ...
            <div class="testimonial-card">
              <div class="testimonial-header">
                <div class="testimonial-image">
                  <img src="{{ asset('temp_5/assets/img/person/person-f-5.webp')}}" class="img-fluid" alt="Testimonial 1">
                </div>
          ...
          <div class="testimonial-item featured" data-aos="zoom-in" data-aos-delay="200">
            <div class="testimonial-card">
              <div class="testimonial-header">
                <div class="testimonial-image">
                  <img src="{{ asset('temp_5/assets/img/person/person-m-5.webp')}}" class="img-fluid" alt="Testimonial 2">
                </div>
                <div class="testimonial-meta">
          ...
          <div class="testimonial-item" data-aos="zoom-in" data-aos-delay="300">
            <div class="testimonial-card">
              <div class="testimonial-header">
                <div class="testimonial-image">
                  <img src="{{ asset('temp_5/assets/img/person/person-f-6.webp')}}" class="img-fluid" alt="Testimonial 3">
                </div>
                <div class="testimonial-meta">
                  <h3>Isabella Kim</h3>
          ...
          <div class="testimonial-item" data-aos="zoom-in" data-aos-delay="400">
            <div class="testimonial-card">
              <div class="testimonial-header">
                <div class="testimonial-image">
                  <img src="{{ asset('temp_5/assets/img/person/person-m-6.webp')}}" class="img-fluid" alt="Testimonial 4">
                </div>
                <div class="testimonial-meta">
                  <h3>James Cooper</h3>
                  <h4>Tech Lead</h4>
              ...
              <div class="testimonial-preview mt-5">
                <div class="testimonial-card">
                  ...
                  <div class="testimonial-author d-flex align-items-center mt-3">
                    <img src="{{ asset('temp_5/assets/img/person/person-f-3.webp')}}" alt="Client" class="author-image me-3">
                    <div>
          ...
          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="100">
            <article class="featured-post">
              <div class="featured-img">
                <img src="{{ asset('temp_5/assets/img/blog/blog-post-7.webp')}}" alt="" class="img-fluid" loading="lazy">
              ...
              <div class="featured-content">
                ...
                <div class="post-footer">
                  <div class="author-info">
                    <img src="{{ asset('temp_5/assets/img/person/person-m-8.webp')}}" alt="" class="author-avatar">
            ...
            <article class="featured-post" data-aos="fade-up" data-aos-delay="400">
              <div class="featured-img">
                <img src="{{ asset('temp_5/assets/img/blog/blog-post-3.webp')}}" alt="" class="img-fluid" loading="lazy">
                <div class="featured-badge">Featured</div>
              </div>
              ...
              <div class="featured-content">
                ...
                <div class="post-footer">
                  <div class="author-info">
                    <img src="{{ asset('temp_5/assets/img/person/person-f-7.webp')}}" alt="" class="author-avatar">
                    <div class="author-details">
          ...
          <div class="col-lg-4">
            ...
            <article class="recent-post" data-aos="fade-up" data-aos-delay="200">
              <div class="recent-img">
                <img src="{{ asset('temp_5/assets/img/blog/blog-post-5.webp')}}" alt="" class="img-fluid" loading="lazy">
              </div>
            ...
            <article class="recent-post" data-aos="fade-up" data-aos-delay="250">
              <div class="recent-img">
                <img src="{{ asset('temp_5/assets/img/blog/blog-post-9.webp')}}" alt="" class="img-fluid" loading="lazy">
              </div>
              <div class="recent-content">
            ...
            <article class="recent-post" data-aos="fade-up" data-aos-delay="300">
              <div class="recent-img">
                <img src="{{ asset('temp_5/assets/img/blog/blog-post-6.webp')}}" alt="" class="img-fluid" loading="lazy">
              </div>
              <div class="recent-content">
            ...
            <article class="recent-post" data-aos="fade-up" data-aos-delay="350">
              <div class="recent-img">
                <img src="{{ asset('temp_5/assets/img/blog/blog-post-8.webp')}}" alt="" class="img-fluid" loading="lazy">
              </div>
              <div class="recent-content">
