                        ...
                        <div class="col-12 col-sm-9">
                            <div class="top-bar-info">
                                <ul>
                                    ...
                                    <li>
                                        <a>
                                            <i class="fa fa-clock"></i> खुलने का समय : {{$rs_school_detail[0]->opening_time_l}}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('template.index',[4,1]) }}"><i class="fa fa-language"></i> View in English</a> 
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-12 col-sm-3">
                            <div class="top-right-bar">
                                <ul class="top-social-icon">
                                    <li>
                                        <a href="{{ route('admin.login') }}" class="btn"><i class="fa fa-lock"></i> <strong>लॉग इन करें</strong></a>
                                    </li>
                                    <li>
                                        <a href="{{ route('template.contact',[4,2]) }}" class="btn"><i class="fa fa-user"></i> <strong>प्रवेश</strong></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="menu_area alt-font">
                                <nav class="navbar navbar-expand-lg navbar-light no-padding">
                                    ...
                                    <ul class="navbar-nav ml-auto" id="nav" style="display: none;margin-right: 10px;">
                                        <li><a href="{{ route('template.index',[4,2]) }}">होम</a></li>
                                        <li><a>के बारे में</a>
                                            <ul>
                                                <li>
                                                    <a href="{{ route('template.about',[4,2]) }}">हमारे बारे में</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('template.whos.message',[4,2])}}">कौन कौन है</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="{{ route('template.gallery',[4,2]) }}">गैलरी</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('template.teacher',[4,2]) }}">अध्यापक</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('template.events',[4,2]) }}">आयोजन</a>
                                        </li>
                                        <li><a>अधिक</a>
                                            <ul>
                                                <li>
                                                  <a href="{{ route('template.features',[4,2]) }}">विशेषताएँ</a>
                                                </li>
                                                <li>
                                                  <a href="{{ route('template.infrastructure',[4,2]) }}">आधारभूत संरचना</a>
                                                </li>
                                                <li><a href="{{ route('template.calendar',[4,2]) }}">पंचांग</a></li>
                                                @foreach ($rs_more_page as $rs_more_page_val)
                                                    <li><a href="{{ route('template.morepage',[4,2,$rs_more_page_val->id])}}">{{$rs_more_page_val->link_name_l}}</a></li>
                                                @endforeach
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="{{ route('template.contact',[4,2]) }}">संपर्क करें</a>
                                        </li>
                                    </ul>
                                    <!-- end menu area -->
                                </nav>
