          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="footer-item">
              ...
              <div class="footer-about text-white">
                <p style="color: #fff;">{!!@$rs_school_detail[0]->footer_description_l!!}</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="footer-item">
              <h4 class="title">त्वरित लिंक</h4>
          ...
          <div class="col-md-6 col-xs-12">
            <ul class="social-default">
              @if (@$rs_school_detail[0]->facebook_link != "")
                <li><a target="_blank" href="{{@$rs_school_detail[0]->facebook_link}}"><i class="fab fa-facebook-f text-white" aria-hidden="true"></i></a></li>
              @elseif(@$rs_school_detail[0]->twitter_link != "")
                <li><a target="_blank" href="{{@$rs_school_detail[0]->twitter_link}}"><i class="fab fa-twitter text-white" aria-hidden="true"></i></a></li>
              @elseif(@$rs_school_detail[0]->youtube_link != "")
              <li><a target="_blank" href="{{@$rs_school_detail[0]->youtube_link}}"><i class="fab fa-youtube text-white" aria-hidden="true"></i></a></li>
              @endif
            </ul>
          </div>
        </div><!-- row -->
