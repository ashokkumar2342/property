...
<body id="scroll-top">
  ...
  <div class="mobile-menu-area">
    <div class="logo-area">
      <a class="logo" href="{{ route('template.index',[2,1]) }}"><img src="{{ asset($rs_school_detail[0]->logo) }}" alt="logo" class="img-responsive"></a>
    ...
    <div class="mobile-menu">
      <ul class="m-menu">
        ...
        <li>
          <a class="text-dark font-weight-medium opacity-80" href="{{ route('template.contact',[2,1]) }}"><i class="fa fa-user" aria-hidden="true"></i> Admission</a>
        </li>
        <li>
          <a class="nav-link dropdown-toggle  active " href="{{ route('template.index',[2,1]) }}">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
            aria-expanded="false"><i class="fa fa-info"></i> About Us <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="{{ route('template.about',[2,1])}}">About</a></li>
            <li><a href="{{ route('template.whos.message',[2,1])}}">Who's Who</a></li>
          </ul>
        </li>

        {{-- <li>
          <a class="nav-link dropdown-toggle  active " href="{{ route('template.about',[2,1]) }}">
            <i class="fa fa-info"></i>
            <span>About Us</span>
          </a>
        </li> --}}
        <li>
          <a class="nav-link dropdown-toggle  active " href="{{ route('template.gallery',[2,1]) }}">
            <i class="fa fa-image"></i>
            <span>Gallery</span>
          </a>
        </li>
        <li>
          <a class="nav-link dropdown-toggle  active " href="{{ route('template.teacher',[2,1]) }}">
            <i class="fa fa-users"></i>
            <span>Teachers</span>
          </a>
        </li>
        <li>
          <a class="nav-link dropdown-toggle  active " href="{{ route('template.events',[2,1]) }}">
            <span>News/Events</span>
          </a>
        </li>
        <li>
          <a class="nav-link dropdown-toggle " href="{{ route('template.contact',[2,1]) }}" style="color:rgba(7, 143, 203, .8);">
            <i class="fa fa-phone"></i>
            <span>Contact Us</span>
          </a>
        </li>
        <li class="dropdown" style="color:rgba(7, 143, 203, .8);">
          <a href="#" style="color:rgba(7, 143, 203, .8);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
            aria-expanded="false"><i class="fa fa-cog"></i> Pages <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li>
              <a href="{{ route('template.features',[2,1]) }}" style="color:rgba(7, 143, 203, .8);">Features</a>
            </li>
            <li>
              <a href="{{ route('template.infrastructure',[2,1]) }}" style="color:rgba(7, 143, 203, .8);">Infrastructure</a>
            </li>

            <li><a href="{{ route('template.calendar',[2,1])}}" style="color:rgba(7, 143, 203, .8);">Calendar</a></li>
            @foreach ($rs_more_page as $rs_more_page_val)
              <li>
                <a style="color:rgba(7, 143, 203, .8);"  href="{{ route('template.morepage',[2,1,$rs_more_page_val->id])}}">{{$rs_more_page_val->link_name}}</a>
              </li>
            @endforeach
          </ul>
        </li>
      ...
      <div class="container">
        <div class="ht-area">
          <ul class="left">
            ...
            <li><span><i class="fa fa-clock-o"></i></span> Opening Time : {{$rs_school_detail[0]->opening_time}}
            </li>
            
          </ul>
          <ul class="right">
            <li><span><i class="fa fa-language" style="color:red"></i></span><a href="{{ route('template.index',[2,2]) }}" style="color:#fff"> हिंदी में देखें</a></li>
            <li>
            ...
            <li>
              <a class="text-white font-weight-medium opacity-80" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#modal-createAccount"><i class="fa fa-user" aria-hidden="true"></i> Admission</a>
            </li>
      ...
      <div class="container">
        <div class="row no-gutters">
          <nav class="main-menu-area w-100">
            <div class="logo-area">
              <a class="" href="{{ route('template.index',[2,1]) }}"><img src="{{ asset($rs_school_detail[0]->logo) }}" alt="logo"
            ...
            <div class="menu-area">
              <ul class="menu">
                ...
                <li>
                  <a class="nav-link dropdown-toggle  active " href="{{ route('template.contact',[2,1]) }}">
                    <i class="fa fa-phone"></i>
                    <span>Contact Us</span>
                  </a>
                </li>
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a href="{{ route('template.features',[2,1]) }}">Features</a>
                    </li>
                    <li>
                      <a href="{{ route('template.infrastructure',[2,1]) }}">Infrastructure</a>
                    </li>
                    <li><a href="{{ route('template.calendar',[2,1])}}">Calendar</a></li>
                    @foreach ($rs_more_page as $rs_more_page_val)
                      <li>
                        <a  href="{{ route('template.morepage',[2,1,$rs_more_page_val->id])}}">{{$rs_more_page_val->link_name}}</a>
                      </li>
                    @endforeach
                  </ul>
                </li>
