<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><b>{{ @$rs_records->id? 'Edit' : 'Add'}} Teacher</b>&nbsp;<i class="small text-muted"></i></h4> 
        </div>
        <div class="modal-body">
            <form action="{{ route('admin.web.gallery.teacher.store',Crypt::encrypt(@$rs_records->id?@$rs_records->id:0)) }}" method="post" class="add_form" button-click="btn_close" content-refresh="result_table" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-lg-12">                           
                    ...
                    <div class="col-lg-6">                           
                        <div class="form-group">
                            <label>Subject</label>
                            <input type="text" name="subject" class="form-control"maxlength="50" value="{{@$rs_records->subject}}">
                        </div>    
                    </div>
                    <div class="col-lg-6">                           
                        <div class="form-group">
                            <label>Subject Hindi</label>
                            <input type="text" name="subject_l" class="form-control"maxlength="50" value="{{@$rs_records->subject_l}}">
                        </div>    
                    </div>
                    <div class="col-lg-6">                           
                        <div class="form-group">
                            <label>Description</label>
                            <input type="text" name="description" class="form-control"maxlength="100" value="{{@$rs_records->description}}">
                        </div>    
                    </div>
                    <div class="col-lg-6">                           
                        <div class="form-group">
                            <label>Description Hindi</label>
                            <input type="text" name="description_l" class="form-control"maxlength="100" value="{{@$rs_records->description_l}}">
                        </div>    
                    </div>
                    <div class="col-lg-6">                         
                        <div class="form-group">
