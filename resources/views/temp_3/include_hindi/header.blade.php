...
<li class="contact-address" style="font-size: 13px;"><i class="fa fa-clock font-icon sm-display-block"></i>खुलने का समय : {{$rs_school_detail[0]->opening_time_l}}</li>
<li class="contact-address"><i class="fa fa-language font-icon sm-display-block"></i> <a href="{{ route('template.index',[3,1]) }}"> View in English</a></li>
</ul>
</div>
<div class="col-xl-auto ms-xl-auto header-top-right align-self-center text-center text-xl-end">
<div class="element pt-0 pt-lg-10 pb-0">
<a href="{{ route('admin.login') }}" class="btn btn-theme-colored2 btn-sm">लॉग इन करें</a>
<a href="{{ route('template.contact',[3,2]) }}" class="btn btn-theme-colored2 btn-sm">प्रवेश</a>
</div>
</div>
</div>
</div>
            ...
            <div class="position-relative">
                <div class="row header-nav-col-row">
                    <div class="col-sm-auto align-self-center">
                        <a style="margin-left: 5px;" class="menuzord-brand site-brand" href="{{ route('template.index',[3,2]) }}">
                    ...
                    <div class="col-sm-auto align-self-center">
                        <a class="menuzord-brand site-brand" href="{{ route('template.index',[3,2]) }}" style="margin-left: 5px;">
                        ...
                        <nav id="top-primary-nav" class="menuzord theme-color1" data-effect="fade" data-animation="none" data-align="right">
                            <ul id="main-nav" class="menuzord-menu">
                                <li class="active menu-item">
                                    <a href="{{ route('template.index',[3,2]) }}">होम</a>
                                </li>
                                <li class="menu-item"><a href="#">के बारे में</a>
                                    <ul class="dropdown">
                                        <li><a href="{{ route('template.about',[3,2]) }}">हमारे बारे में</a></li>
                                        <li><a href="{{ route('template.whos.message',[3,2])}}">कौन कौन है</a></li>
                                    </ul>
                                </li>
                                <li class="menu-item">
                                    <a href="{{ route('template.gallery',[3,2]) }}">गैलरी</a>
                                </li>
                                <li class="menu-item">
                                    <a href="{{ route('template.teacher',[3,2]) }}">अध्यापक</a>
                                </li>
                                <li class="menu-item">
                                    <a href="{{ route('template.events',[3,2]) }}">आयोजन</a>
                                </li>
                                <li class="menu-item">
                                    <a href="{{ route('template.contact',[3,2]) }}">संपर्क करें</a>
                                </li>
                                <li class="menu-item"><a href="#">अधिक</a>
                                    <ul class="dropdown">
                                        <li>
                                          <a href="{{ route('template.features',[3,2]) }}">विशेषताएँ</a>
                                        </li>
                                        <li>
                                          <a href="{{ route('template.infrastructure',[3,2]) }}">आधारभूत संरचना</a>
                                        </li>
                                        <li><a href="{{ route('template.calendar',[3,2]) }}">पंचांग</a></li>
                                        @foreach ($rs_more_page as $rs_more_page_val)
                                            <li><a href="{{ route('template.morepage',[3,1,$rs_more_page_val->id])}}">{{$rs_more_page_val->link_name_l}}</a></li>
                                        @endforeach
                                    </ul>
                                </li>
                            </ul>
